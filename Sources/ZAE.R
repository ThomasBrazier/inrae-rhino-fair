# The inflated Exponential distribution
# free implementation by Thomas Brazier from he ZAGA function created by Bob Rigby and Mikis Stasinopoulos and Gillian Heller
# 2019
...
dZAE<-function(x, mu=1, sigma=1, nu=.1, log=FALSE)
...
{ 
  ...
  # if(log==FALSE) fy  <- exp(log.lik) else
  fy <- log.lik
