...
dbExtract=function() {
  ...
  timeIn=Sys.time()
  # working dir INRA
  #wd="W:/R/Assignation/01_prepadata/"
  #wd="C:/Users/tbrazier/Desktop/R/Assignation/01_prepadata/"
  # working dir HOME
  #wd="~/Dropbox/M1 EFCE/INRA RHINO/R/Assignation/01_prepadata/"
...
UniqueGenotypes=function(BDD,falseloci=1,withcolony=F,sexmark=F) {
  #### Fonction pour construire le jeu de donn̩es avec les individus (genotypes uniques)
  ...
  #-------------------------------#
  # Creer un fichier de tous les genotypes uniques (individus deja connus : 4046)
  #-------------------------------#
  ...
  # ('P412',CXSGT','M244','M399','M809','M811','M813','M815','M831','M1079','M1102','M1106','M1112','M1113','M1551','M1975','M1979','PP1','PP3')
...
effectifsTable=function(unique) {
  ...
  JuvF=c(JuvF2015,JuvF2016,JuvF2017) # Nombre de nouveaux juveniles femelles par an, 2013:2016
  JuvM=c(JuvM2015,JuvM2016,JuvM2017) # Nombre de nouveaux juveniles males par an
  AdultF=c(AdultF2015,AdultF2016,AdultF2017) # Nombre de nouveaux adultes femelles par an
  AdultM=c(AdultM2015,AdultM2016,AdultM2017) # Nombre de nouveaux adultes males par an
  ...
  write.table(effectifs,paste(wd,"effectifs.txt",sep=""),row.names=F,col.names=T,quote=F,sep="\t")
  return(effectifs)
}
